...
-- Inserting 2 default ROLE_USER users for easy testing, password = userPassword --
...
-- Inserting a few genres to initialize the default book stock --
...
insert into book (id, title, author, copies, copies_available, description, img) values (10000005, 'Title 5', 'Author 5', 10, 10, 'Description 5', 'Encoded image 5') on conflict do nothing;
...
-- Inserting payment fee for the first user for testing --
insert into payment (id, person_email, amount) values (10000001, 'email1@email.com', 10.00) on conflict do nothing;

-- Inserting history record for the first user for testing --
...
-- Inserting discussions for the first user for testing --
...
-- Inserting checkouts for the first user for testing --
